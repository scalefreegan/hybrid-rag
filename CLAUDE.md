...
**YOU ARE IN: `hybrid_rag/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/hybrid_rag/` (rig root) or other directories
...
**Your mail address:** `hybrid_rag/polecats/obsidian`
**Your rig:** hybrid_rag
**Your Witness:** `hybrid_rag/witness`
...
| Ask Witness for help | `gt mail send hybrid_rag/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`hybrid_rag/witness`) when:
...
```bash
gt mail send hybrid_rag/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
